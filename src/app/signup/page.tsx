        ...
        {success ? (
          <>
            ...
            <div style={{
              ...
              <Link href="/login" className="smallcaps" style={{
          ...
          <>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.65, color: "var(--forest-ink)", margin: "0 0 32px" }}>
              Create your account to access compliance tools and portfolio management.
            </p>
            ...
            <form onSubmit={handleSignup}>
              ...
              <p style={{ fontSize: 12, color: "var(--forest-ink)", marginBottom: 24, fontStyle: "italic", opacity: .7 }}>
              ...
              <p style={{ fontSize: 13, color: "var(--forest-ink)", marginTop: 20, textAlign: "center" }}>
                ...
                <Link href="/login" style={{ color: "var(--emerald)", borderBottom: "1px solid var(--emerald)" }}>
                  Sign in
                </Link>
              </p>
